    ...
    <footer className="w-full bg-[#fdfdfd] text-zinc-600 font-sans border-t border-zinc-100 relative py-12 px-4 sm:px-8 lg:px-12">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        ...
        <a
          ...
          className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 relative group animate-bounce"
        ...
        <a
          href="tel:+918294107610"
          aria-label="Call Now"
          className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 relative group"
        >
