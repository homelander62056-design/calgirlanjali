    ...
    <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 py-3 space-y-4">
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-2xl shadow-xs border border-zinc-200 space-y-3">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pt-1 pb-1 scrollbar-thin">
          <span className="text-xs font-bold text-zinc-500 shrink-0">Top search location</span>
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between relative z-10 bg-white">
                    ...
                    <div className="pt-4 border-t border-zinc-100 flex items-center justify-between mt-auto">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a
                          href={`tel:${cleanPhone}`}
                          className="w-9 h-9 rounded-full bg-[#ff2d55] text-white flex items-center justify-center"
                          title="Call Now"
                        >
                          <svg
